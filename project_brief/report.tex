...
\texttt{search\_files} & 文件 & \textbf{Everything 毫秒级文件搜索（回退递归）} \\
...
\texttt{query\_scores} & 学业 & 成绩查询 \\
\texttt{query\_schedule} & 学业 & 课表查询 \\
\texttt{query\_exams} & 学业 & 考试查询 \\
\texttt{query\_user\_status} & 学业 & 学业概览 \\
